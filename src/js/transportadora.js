    ...
    fetch("http://localhost:8800/transportadoras/listar")
        ...
        .then((transportadoras) => {
            ...
            transportadoras.forEach((tran) => {
                ...
                <td>${tran.taxa}</td>
            `;
                const tdRegioes = document.createElement("td");
                tdRegioes.textContent = tran.regioes.join(", ");
                tr.appendChild(tdRegioes); // Aqui sim estamos passando um nó real!
...
document.addEventListener("DOMContentLoaded", () => {
    const spans = document.querySelectorAll('.transportadora.submenu span');
